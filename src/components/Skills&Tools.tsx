...
// --- SKILLS DATA ---
type ToolGroup = "Programming Languages" | "Frontend Development" | "Backend Development" | "Software & Tools";
    ...
    <div className="py-2.5">
      ...
      <div className="relative h-2 w-full overflow-hidden rounded-full bg-muted/40">
        <motion.div
          ...
          style={{
            background: t.name === "Next.js" || t.name === "Shadcn UI" 
    ...
    <main className="relative overflow-x-hidden">
      ...
      <div className="relative pt-32 pb-24">
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          >
            A comprehensive look at my technical skills, tools, and expertise in fullstack web development.
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pb-32 lg:px-8">
        ...
        >
          ...
          <p className="max-w-4xl text-base leading-relaxed text-muted-foreground">
            I started my career as a freelance web developer in 2024. I've explored various programming languages and tech stacks across Back-End and Front-End development, with a strong focus on building scalable architectures utilizing Next.js, Django, and PostgreSQL.
          </p>
        </motion.div>
        ...
        <div className="mt-20 flex flex-col gap-16">
          ...
          <section>
            <h2 className="mb-6 text-xl font-extrabold text-foreground border-b border-border/40 pb-4">
              Programming Languages
            </h2>
        ...
        <div className="mt-32">
          ...
          >
            ...
            <div className="flex flex-col gap-4 rounded-[2rem] border border-border/50 bg-card/20 p-8 sm:p-10 transition-colors hover:bg-card/40">
              <div className="text-[#0284c7] dark:text-[#74d4ff]">
                <MonitorDot className="size-6 stroke-[2.5]" />
              </div>
              <div>
                <h3 className="mb-2 text-lg font-extrabold text-foreground">Web Applications</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Building high-performance, interactive full-stack web applications from end to end.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 rounded-[2rem] border border-border/50 bg-card/20 p-8 sm:p-10 transition-colors hover:bg-card/40">
              ...
              <div>
                <h3 className="mb-2 text-lg font-extrabold text-foreground">UI Components</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Developing clean, accessible, and highly reusable frontend component libraries.
                </p>
              </div>
            </div>

            {/* Box 3: API Architecture (Replaces Mobile Dev) */}
            <div className="flex flex-col gap-4 rounded-[2rem] border border-border/50 bg-card/20 p-8 sm:p-10 transition-colors hover:bg-card/40">
              <div className="text-[#0284c7] dark:text-[#74d4ff]">
                <Server className="size-6 stroke-[2.5]" />
              </div>
              <div>
                <h3 className="mb-2 text-lg font-extrabold text-foreground">API Architecture</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Designing robust, secure, and scalable RESTful endpoints for seamless client-server integration.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 rounded-[2rem] border border-border/50 bg-card/20 p-8 sm:p-10 transition-colors hover:bg-card/40">
              ...
              <div>
                <h3 className="mb-2 text-lg font-extrabold text-foreground">Documentation</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Creating easy-to-navigate, well-structured technical documentation for systems and APIs.
                </p>
              </div>
            </div>
